...
from p0_system_api.configuration import Configuration
import p0_system_api.models
from p0_system_api import rest
from p0_system_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(p0_system_api.models, klass)
